...
设$X$是 Banach 空间，$A \in \mathscr{C}(X)$，如果想了解$A$的谱，我们可以考虑算子$T=\mathbbm{I}-A$，先考察有限维的情况，如取$X=\mathbb{R}^n$，考虑方程$Tx=y$。那么有以下两种状况，由 Fredholm 二择一定理所描述。
...
\end{itemize}
\end{definition}
\begin{theorem}[Riesz-Fredholm 定理]
...
\end{theorem}
\begin{remark}
\quad 由二三点可知，紧算子$A$使得$T$还原到有限维，$T$的单射等价于满射，且$T$不是单的也可以有类似结论。
\end{remark}
