\begin{introduction}
    ...
    \item Riesz 表示定理~\ref{theorem:rieszbs}
\end{introduction}
...
\item 1. 若$M \subset H$，$\exists \, x \in H-M$对$\forall y \in M$都有$(x,y)=0$，则称$x$与$M$正交，记为$x \perp M$；
\item 2. 若$M,N \subset H$，对$\forall x \in N \ , \ y \in M$都有$(x,y)=0$，则称$N$与$M$正交，记为$N \perp M$；
\item 3. 若$M \subset H$，可以定义$M$的正交补$M^{\perp}=\{x \in H|x \perp M\}$，正交补$M^{\perp}$是闭线性子空间。
\item 4. 若$M \subset N \subset H$，则$M^{\perp} \supset N^{\perp}$。
\end{itemize}
...
\begin{theorem}\label{theorem:yqzj}
